    ...
    <div class="row">
        <div class="col-lg-7 mx-auto">
                        ...
                        @foreach ($languages as $key => $language)
                            <li class="nav-item">
                                <a class="nav-link @if ($language->code == $lang) active border-0 @else bg-light @endif py-3"
                                    href="{{ route('plugin.cartlookscore.product.attributes.edit', ['id' => $attribute_details->id, 'lang' => $language->code]) }}">
            ...
            <div class="form-element py-30 mb-30">
                <form action="{{ route('plugin.cartlookscore.product.attributes.update') }}" method="POST"
