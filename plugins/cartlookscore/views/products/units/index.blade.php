                ...
                <div class="card-body border-bottom2 mb-20">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex flex-wrap">
                            <a href="{{ route('plugin.cartlookscore.product.units.new') }}"
                                    ...
                                    <td>
                                        <div class="dropdown-button">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a
                                                    href="{{ route('plugin.cartlookscore.product.units.edit', ['id' => $unit->id, 'lang' => getDefaultLang()]) }}">
                                                    {{ translate('Edit') }}
                                                </a>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="POST" action="{{ route('plugin.cartlookscore.product.units.delete') }}">
                        @csrf
            ...
            $('.apply-bulk-action').on('click', function(e) {
                ...
                if (action === 'delete_all') {
                    ...
                    if (selected_items.length > 0) {
                        $.post('{{ route('plugin.cartlookscore.product.units.delete.bulk') }}', {
                            _token: '{{ csrf_token() }}',
                            data: selected_items
                        }, function(data) {
                            location.reload();
