                ...
                <div class="card-body border-bottom2 mb-20">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex flex-wrap">
                            <a href="{{ route('plugin.cartlookscore.product.collection.add.new') }}"
                        ...
                        <tbody>
                            @foreach ($collections as $key => $collection)
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            href="{{ route('plugin.cartlookscore.product.collection.products', $collection->id) }}">
                                    ...
                                    <td>
                                        <div class="dropdown-button">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a
                                                    href="{{ route('plugin.cartlookscore.product.collection.edit', ['id' => $collection->id, 'lang' => getDefaultLang()]) }}">
                                                    {{ translate('Edit') }}
                                                </a>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="POST" action="{{ route('plugin.cartlookscore.product.collection.delete') }}">
                        @csrf
    ...
    <script>
        (function($) {
            ...
            $('.apply-bulk-action-btn').on('click', function(e) {
                ...
                if (action === 'delete_all') {
                    ...
                    if (selected_items.length > 0) {
                        $.post('{{ route('plugin.cartlookscore.product.collection.delete.bulk') }}', {
                            _token: '{{ csrf_token() }}',
                            data: selected_items
                        }, function(data) {
                            location.reload();
            ...
            $('.change-status').on('click', function(e) {
                ...
                $.post('{{ route('plugin.cartlookscore.product.collection.update.status') }}', {
                    _token: '{{ csrf_token() }}',
                    id: id
                }, function(data) {
                    location.reload();
