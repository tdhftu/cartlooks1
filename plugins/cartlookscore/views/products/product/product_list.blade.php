        ...
        <div class="col-12">
            <div class="card mb-30">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        @can('Manage Add New Product')
                            <div class="d-flex flex-wrap">
                                <a href="{{ route('plugin.cartlookscore.product.add.new') }}"
                ...
                <div class="px-2 filter-area d-flex align-items-center">
                    <!--Filter area-->
                    <form method="get" action="{{ route('plugin.cartlookscore.product.list') }}">
                    ...
                    @if (request()->has('search_key') || request()->has('payment_status'))
                        <a class="btn long btn-danger" href="{{ route('plugin.cartlookscore.product.list') }}">
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="POST" action="{{ route('plugin.cartlookscore.product.delete') }}">
                        @csrf
            ...
            $('.fire-bulk-action').on('click', function(e) {
                ...
                if (action != 'null') {
                    ...
                    if (selected_items.length > 0) {
                        $.post('{{ route('plugin.cartlookscore.product.bulk.action') }}', {
                            _token: '{{ csrf_token() }}',
