        ...
        <div class="col-12">
            <div class="card mb-30">
                ...
                <div class="px-2 filter-area d-flex align-items-center mb-10">
                    <form method="get" action="{{ route('plugin.cartlookscore.product.reviews.list') }}">
                    ...
                    <a class="btn long btn-danger"
                        href="{{ route('plugin.cartlookscore.product.reviews.list') }}">{{ translate('Clear Filter') }}</a>
                            ...
                            @if ($reviews->count() > 0)
                                @foreach ($reviews as $key => $review)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('plugin.cartlookscore.customers.details', ['id' => $review->customer_id]) }}"
                                                target="_blank">
