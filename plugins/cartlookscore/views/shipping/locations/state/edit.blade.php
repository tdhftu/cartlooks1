        ...
        <div class="col-lg-6 mx-auto">
            ...
            <div class="card mb-30">
                ...
                <div class="card-body">
                        ...
                        @foreach ($languages as $key => $language)
                            <li class="nav-item">
                                <a class="nav-link @if ($language->code == $lang) active border-0 @else bg-light @endif py-3"
                                    href="{{ route('plugin.cartlookscore.shipping.locations.states.edit', ['id' => $stateDetails->id, 'lang' => $language->code]) }}">
                    ...
                    <form action="{{ route('plugin.cartlookscore.shipping.locations.states.update') }}" method="POST">
                        @csrf
