        ...
        <div class="col-12">
            <div class="card mb-30">
                <div class="card-body border-bottom2 mb-20">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex flex-wrap">
                            <a href="{{ route('plugin.cartlookscore.shipping.locations.country.new') }}"
                ...
                <div class="px-2 filter-area d-flex align-items-center">
                    <!--Filter area-->
                    <form method="get" action="{{ route('plugin.cartlookscore.shipping.locations.country.list') }}">
                    ...
                    @if (request()->has('search_key'))
                        <a class="btn long btn-danger"
                            href="{{ route('plugin.cartlookscore.shipping.locations.country.list') }}">
                                        ...
                                        <td>
                                            <div class="dropdown-button">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a
                                                        href="{{ route('plugin.cartlookscore.shipping.locations.country.edit', ['id' => $country->id, 'lang' => getDefaultLang()]) }}">
                                                        {{ translate('Edit') }}
                                                    </a>
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <form method="POST" action="{{ route('plugin.cartlookscore.shipping.locations.country.delete') }}">
                        @csrf
    ...
    <script>
        (function($) {
            ...
            $('.change-status').on('click', function(e) {
                ...
                $.post('{{ route('plugin.cartlookscore.shipping.locations.country.status.change') }}', {
                    _token: '{{ csrf_token() }}',
                    id: id
                }, function(data) {
                    location.reload();
            ...
            $('.fire-bulk-action').on('click', function(e) {
                ...
                if (action != 'null') {
                    ...
                    if (selected_items.length > 0) {
                        $.post('{{ route('plugin.cartlookscore.shipping.locations.country.bulk.action') }}', {
                            _token: '{{ csrf_token() }}',
