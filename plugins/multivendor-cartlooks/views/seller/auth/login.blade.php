...
@section('custom_css')
    <style>
        .login-page-layout {
            height: 100vh;
            background-image: url('/public/web-assets/backend/img/seller-log-in-bg.jpg');
