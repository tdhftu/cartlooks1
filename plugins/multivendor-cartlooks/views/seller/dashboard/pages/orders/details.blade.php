                                            ...
                                            <div class="product-select-box">
                                                <label class="d-flex justify-content-between m-0 py-1">
                                                    ...
                                                    <input type="checkbox" class="order-product-id"
                                                        value="{{ $product->id }}" @disabled($product->delivery_status == config('cartlookscore.order_delivery_status.delivered'))
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-12  mb-20">
                                        ...
                                        <select class="theme-input-style" name="delivery_status" id="delivery_status">
                                            ...
                                            <option
                                                value="{{ config('cartlookscore.order_delivery_status.ready_to_ship') }}">
                                            ...
                                            <option
                                                value="{{ config('cartlookscore.order_delivery_status.cancelled') }}">
                                                {{ translate('Cancelled') }}
                                            </option>
                                        </select>
            ...
            <div id="order-shipping-label-modal" class="order-shipping-label-modal modal fade show" aria-modal="true"
                ...
                <div class="modal-dialog modal-md modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body pt-0">
                            <form method="POST"
                                action="{{ route('plugin.cartlookscore.orders.print.shipping.label') }}">
                                @csrf
                                <p class="text-error"></p>
                                <input type="hidden" name="order_id" value="{{ $order_details->id }}">
                                <!--Product checkbox-->
                                            ...
                                            <div class="product-select-box">
                                                <label class="d-flex justify-content-between m-0 py-1">
                                                    ...
                                                    <input type="checkbox" class="invoice-product"
                                                        value="{{ $product->id }}" @disabled($product->delivery_status == config('cartlookscore.order_delivery_status.cancelled'))
