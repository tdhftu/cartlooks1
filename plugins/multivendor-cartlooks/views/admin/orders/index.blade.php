        ...
        <div class="col-12">
            <div class="card mb-30">
                ...
                <div class="px-2 filter-area d-flex align-items-center mb-20">
                    ...
                    <a href="{{ route('plugin.multivendor.admin.seller.order.list', ['delivery_status' => config('cartlookscore.order_delivery_status.pending')]) }}"
                        class="btn sm btn-primary">{{ translate('Pending') }}
                        ({{ $order_counter != null ? $order_counter['pending'] : 0 }})
                    </a>
                    <a href="{{ route('plugin.multivendor.admin.seller.order.list', ['delivery_status' => config('cartlookscore.order_delivery_status.processing')]) }}"
                        class="btn sm btn-info">{{ translate('Processing') }}
                        ({{ $order_counter != null ? $order_counter['processing'] : 0 }})
                    </a>
                    <a href="{{ route('plugin.multivendor.admin.seller.order.list', ['delivery_status' => config('cartlookscore.order_delivery_status.ready_to_ship')]) }}"
                        class="btn sm btn-success">{{ translate('Ready to ship') }}
                        ({{ $order_counter != null ? $order_counter['ready_to_ship'] : 0 }})
                    </a>
                    <a href="{{ route('plugin.multivendor.admin.seller.order.list', ['delivery_status' => config('cartlookscore.order_delivery_status.shipped')]) }}"
                        class="btn sm">{{ translate('To Shipped') }}
                        ({{ $order_counter != null ? $order_counter['shipped'] : 0 }})
                    </a>
                    <a href="{{ route('plugin.multivendor.admin.seller.order.list', ['delivery_status' => config('cartlookscore.order_delivery_status.delivered')]) }}"
                        class="btn sm btn-success">{{ translate('Delivered') }}
                        ({{ $order_counter != null ? $order_counter['delivered'] : 0 }})
                    </a>
                    <a href="{{ route('plugin.multivendor.admin.seller.order.list', ['payment_status' => config('cartlookscore.order_payment_status.unpaid')]) }}"
                        class="btn sm btn-warning">{{ translate('Unpaid') }}
                        ({{ $order_counter != null ? $order_counter['unpaid'] : 0 }})
                    </a>
                    <a href="{{ route('plugin.multivendor.admin.seller.order.list', ['payment_status' => config('cartlookscore.order_payment_status.paid')]) }}"
                        class="btn sm btn-success">{{ translate('Paid') }}
                        ({{ $order_counter != null ? $order_counter['paid'] : 0 }})
                    </a>
                    <a href="{{ route('plugin.multivendor.admin.seller.order.list', ['delivery_status' => config('cartlookscore.order_delivery_status.cancelled')]) }}"
