...
class LanguageController extends Controller
{
    ...
    {
        return view('core::base.system.language.index')->with(
            [
    ...
    public function newLanguage()
    {
        ...
        return view('core::base.system.language.new_language');
    }
    /**
     * Store new language
     * 
    ...
    public function editLanguage($id)
    {
        ...
        return view('core::base.system.language.edit_language', compact('lang'));
    }
    /**
     * Update language
     * 
    ...
    public function languageKeyValues(Request $request, $id)
    {
        ...
        return view('core::base.system.language.lan_key_values')->with(
            [
                'language' => $language,
                'lang_keys' => $lang_keys,
            ]
    ...
    public function frontendTranslations(Request $request, $id)
    {
        ...
        if ($active_theme != null) {
            ...
            return view('core::base.system.language.theme_translations')->with(
                [
                    'language' => $language,
                    'lang_keys' => $lang_keys,
    ...
    public function themeTranslations()
    {
        ...
        if ($active_theme != null) {
            ...
            return view('core::base.system.language.tl_tranalations')->with(
                [
                    'lang_keys' => $lang_keys,
                    'theme' => $active_theme->location
                ]
    ...
    public function resetActiveLanguagesCache()
    {
        ...
        Cache::rememberForever('active-languages', function () {
