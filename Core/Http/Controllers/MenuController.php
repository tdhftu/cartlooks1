...
class MenuController extends Controller
{
  ...
  public function searchProductCategoryByKeywords(Request $request)
  {
    try {
      ...
      return view('plugin/cartlookscore::menu.partial.filtered_product_categories', compact('all_product_categories'));
    } catch (\Exception $e) {
      return response()->json([
        'success' => false,
        'message' => translate("Invalid Request")
  ...
  public function searchProductTagByKeywords(Request $request)
  {
    try {
      ...
      return view('plugin/cartlookscore::menu.partial.filtered_product_tags', compact('all_product_tags'));
    } catch (\Exception $e) {
      return response()->json([
        'success' => false,
        'message' => translate("Invalid Request")
  ...
  public function searchProductBrandByKeywords(Request $request)
  {
    try {
      ...
      return view('plugin/cartlookscore::menu.partial.filtered_product_brands', compact('all_product_brands'));
    } catch (\Exception $e) {
      return response()->json([
        'success' => false,
        'message' => translate("Invalid Request")
