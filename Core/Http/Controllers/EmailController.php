...
class EmailController extends Controller
{
    ...
    {
        return view('core::base.business.email.smtp.smtp_config');
    }
    /**
    ...
    {
        return view('core::base.business.email.email_templates.index');
    }
    ...
    public function getEmailTemplateVariables(Request $request)
    {
        ...
        return view('core::base.business.email.email_templates.email_template_variables', compact('variables'));
    }
}
