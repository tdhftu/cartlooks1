                    ...
                    <div class="col-md-12 row my-3 d-none" id="avatar_settings">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="mb-2">
                                ...
                                <img src="{{ asset('/public/web-assets/backend/img/comment-author-image/mystery.png') }}"
                                    alt="">
                            ...
                            <div class="mb-2">
                                ...
                                <img src="{{ asset('/public/web-assets/backend/img/comment-author-image/blank.png') }}"
                                    alt="">
                            ...
                            <div class="mb-2">
                                ...
                                <img src="{{ asset('/public/web-assets/backend/img/comment-author-image/gravatar.png') }}"
                                    alt="">
                            ...
                            <div class="mb-2">
                                ...
                                <img src="{{ asset('/public/web-assets/backend/img/comment-author-image/identicon.png') }}"
                                    alt="">
                                <label for="identicon"
                            ...
                            <div class="mb-2">
                                ...
                                <img src="{{ asset('/public/web-assets/backend/img/comment-author-image/wavatar.png') }}"
                                    alt="">
                            ...
                            <div class="mb-2">
                                ...
                                <img src="{{ asset('/public/web-assets/backend/img/comment-author-image/monsterid.png') }}"
                                    alt="">
                                <label for="monsterid"
                            ...
                            <div class="">
                                ...
                                <img src="{{ asset('/public/web-assets/backend/img/comment-author-image/retro.png') }}"
                                    alt="">
