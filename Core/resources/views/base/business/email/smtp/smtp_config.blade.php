...
@section('main_content')
    <div class="theme-option-container">
        @include('core::base.business.includes.header', ['sub_link' => 'Email Settings'])
        <div class="theme-option-tab-wrap">
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active ">
                    ...
                    <div class="form-wrapper p-3">
                        <form action="{{ route('core.email.update.smtp.configuration') }}" method="POST">
                            ...
                            <div class="setup-send-mail-smtp">
                                <div class="form-row mb-20">
                                    <div class="col-sm-4">
                                        <label class="font-14 bold black">{{ translate('MAIL HOST') }}
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        ...
                                        @if ($errors->has('mail_host'))
                                            <div class="invalid-input">{{ $errors->first('mail_host') }}
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-row mb-20">
                                    <div class="col-sm-4">
                                        <label class="font-14 bold black">{{ translate('MAIL PORT') }}
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        ...
                                        @if ($errors->has('mail_port'))
                                            <div class="invalid-input">{{ $errors->first('mail_port') }}
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-row mb-20">
                                    <div class="col-sm-4">
                                        <label class="font-14 bold black">{{ translate('MAIL USERNAME') }}
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        ...
                                        @if ($errors->has('mail_user_name'))
                                            <div class="invalid-input">
                                                {{ $errors->first('mail_user_name') }}</div>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-row mb-20">
                                    <div class="col-sm-4">
                                        <label class="font-14 bold black">{{ translate('MAIL PASSWORD') }}
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        ...
                                        @if ($errors->has('mail_password'))
                                            <div class="invalid-input">
                                                {{ $errors->first('mail_password') }}</div>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-row mb-20">
                                    <div class="col-sm-4">
                                        <label class="font-14 bold black">{{ translate('MAIL ENCRYPTION') }}
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        ...
                                        @if ($errors->has('mail_encryption'))
                                            <div class="invalid-input">
                                                {{ $errors->first('mail_encryption') }}</div>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-row mb-20">
                                    <div class="col-sm-4">
                                        <label class="font-14 bold black">{{ translate('MAIL FROM ADDRESS') }}
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        ...
                                        @if ($errors->has('mail_from'))
                                            <div class="invalid-input">{{ $errors->first('mail_from') }}
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-row mb-20">
                                    <div class="col-sm-4">
                                        <label class="font-14 bold black">{{ translate('MAIL FROM NAME') }}
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        ...
                                        @if ($errors->has('mail_from_name'))
                                            <div class="invalid-input">
                                                {{ $errors->first('mail_from_name') }}</div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            <div class="main-gun-setup @if (env('MAIL_MAILER') != 'mailgun') d-none @endif">
                                <div class="form-row mb-20">
                                    <div class="col-sm-4">
                                        <label class="font-14 bold black">{{ translate('MAILGUN DOMAIN') }}
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        ...
                                        @if ($errors->has('mailgun_domain'))
                                            <div class="invalid-input">
                                                {{ $errors->first('mailgun_domain') }}</div>
                                        @endif
                                    </div>
                                </div>
                                <div class="form-row mb-20">
                                    <div class="col-sm-4">
                                        <label class="font-14 bold black">{{ translate('MAILGUN SECRET') }}
                                        </label>
                                    </div>
                                    <div class="col-sm-8">
                                        ...
                                        @if ($errors->has('mailgun_secret'))
                                            <div class="invalid-input">
                                                {{ $errors->first('mailgun_secret') }}</div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-header bg-white border-bottom2 border-top2 py-3">
                        <h4>{{ translate('Test Email') }}</h4>
                    </div>
                    <div class="form-wrapper p-3">
