...
class BlogRepository
{
    ...
    public function blogCreateUpdate($request, $id = null, $action = null)
    {
        ...
        $blog->reading_time = $this->getReadingTime($request['content']);
    ...
    /**
     * return all recent categories
     * @return String
     */
    public function getAllRecentCategories()
    {
     ...
     * Get All tags
     */
    public function getAllTagsForMenu()
    {
     ...
     * Get all recent tags
     */
    public function getAllRecentTagsForMenu()
    {
