...
{{-- Header Logo Switch Start --}}
<div class="form-group row py-4 border-bottom">
    <div class="col-xl-4 mb-3">
        <label class="font-16 bold black">{{ translate('Custom Header Logo Style') }}
        </label>
        <span class="d-block">{{ translate('Switch on for custom header logo style.') }}</span>
    </div>
    <div class="col-xl-6 offset-xl-1">
        <label class="switch success">
            <input type="hidden" name="custom_header_logo" value="0">
            <input type="checkbox"
                {{ isset($option_settings['custom_header_logo']) && $option_settings['custom_header_logo'] == 1 ? 'checked' : '' }}
...
{{-- Custom Header Logo Field Start --}}
