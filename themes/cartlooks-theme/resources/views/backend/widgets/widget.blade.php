...
@section('custom_scripts')
    ...
    <script>
        ...
        function getSidebarHasWidgetField(sidebar_has_widget_id, widget_id, widget, lang = '') {
            $.ajax({
                type: "post",
                url: '{{ route('theme.cartlooks-theme.widget.get_input_field') }}',
                data: {
                    widget_id: widget_id,
        ...
        function saveWidgetToSidebar(sidebar_attr_id, widget_id, element = null) {
            ...
            $.ajax({
                type: "post",
                url: '{{ route('theme.cartlooks-theme.widget.addToSidebar') }}',
                data: {
        ...
        function removeWidgeFromSidebar(sidebar_attr_id, sidebar_has_widget_id, element = null) {
            ...
            $.ajax({
                type: "post",
                url: '{{ route('theme.cartlooks-theme.widget.removeFromSidebar') }}',
                data: {
                    sidebar_id: sidebar_id,
                    sidebar_has_widget_id: sidebar_has_widget_id,
                },
        ...
        function saveWidgetsOrder(sidebar_attr_id) {
            ...
            $.ajax({
                type: "post",
                url: '{{ route('theme.cartlooks-theme.widget.saveWidgetOrder') }}',
                data: {
                    order: order,
                    sidebar_id: sidebar_id,
                },
        ...
        function widgetInputFormSubmit(element) {
            ...
            $.ajax({
                type: "post",
                url: '{{ route('theme.cartlooks-theme.widget.widgetSidebarForm') }}',
                data: {
                    data: formData,
                    sidebar_has_widget_id: sidebar_has_widget_id
                },
        ...
        function authorSocialLink() {
            var url = '{{ route('theme.cartlooks-theme.options') }}';
