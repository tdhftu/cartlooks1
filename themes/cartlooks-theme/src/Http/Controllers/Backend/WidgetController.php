...
use Theme\CartLooksTheme\Repositories\WidgetRepository;
...
class WidgetController extends Controller
{
  ...
  public function __construct(WidgetRepository $widget_repository)
  {
    ...
    getThemeWidgetNameAsArray('cartlooks_theme_widget'); //theme widget
    getThemeSidebarNameAsArray('cartlooks_theme_sidebar'); //theme sidebars
  }
  ...
  public function widgets()
  {
    try {
      ...
      return view('theme/cartlooks-theme::backend.widgets.widget', compact('widgets', 'sidebars'));
    } catch (\Exception $e) {
  ...
  public function getWidgetInputFields(Request $request)
  {
    try {
      if (isset($request->sidebar_has_widget_id) && is_numeric($request->sidebar_has_widget_id)) {
        ...
        $html = view('theme/cartlooks-theme::backend.widgets.widget-forms.' . $widget_name, compact('value', 'sidebar_has_widget_id', 'widget_id', 'lang'))->render();
