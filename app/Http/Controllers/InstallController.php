...
class InstallController extends Controller
{
    ...
    /**
     * Will check folder & file permission
     */
     ...
     *@return mixed
     */
    public function setDatabaseCredentials(Request $request)
    {
     ...
     * 
     */
    public function adminRegistration(Request $request): RedirectResponse
    {
        $request->validate([
        ...
        try {
            ...
            $this->setSystemName($request['system_name']);
